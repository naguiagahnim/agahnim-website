...
export default function Dev() {
    return (
        <div className="bg-light-pink-ouga bg-cover bg-center h-screen w-screen">
            <Navbar />
            <video className="fixed top-0 left-0 w-screen h-screen object-cover z-0" autoPlay muted loop src="/videos/dev.mp4" preload="auto"></video>
            <div className="bg-radial from-pink-ouga to-lavender-ouga mt-4 relative z-10 flex flex-col items-center px-4 space-y-4 max-w-4xl mx-auto p-6">
