...
export default function About() {
    ...
    return (
        <div className="bg-light-pink-ouga bg-cover bg-center h-screen w-screen">
            ...
            <div className="bg-[url(/images/tiledbgpink.webp)] relative z-10 flex flex-col items-center px-12 space-y-4 max-w-4xl mx-auto p-6 mt-4 border-5 border-darker-pink-ouga">
