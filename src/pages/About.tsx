...
export default function About() {
    return (
        <div className="bg-light-pink-ouga bg-cover bg-center h-screen w-screen">
            ...
            <div className="bg-radial-[at_center] from-pink-ouga from-40% to-lavender-ouga to-90% relative z-10 flex flex-col items-center px-4 space-y-4 max-w-4xl mx-auto p-6 rounded mt-4">
