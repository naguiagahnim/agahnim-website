...
export default function Music() {
    ...
    return (
        <div className="bg-light-pink-ouga bg-cover bg-center min-h-screen w-screen" >
            ...
            <div className="bg-radial-[at_center] from-pink-ouga from-40% to-lavender-ouga to-90% relative z-10 flex flex-col items-center px-4 space-y-4 max-w-4xl mx-auto mt-4 p-6 border-4 border-t-white border-l-white border-r-[#808080] border-b-[#808080]">
